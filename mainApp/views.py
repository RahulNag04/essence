...
def checkoutPage(Request):
    ...
    subcategory = Subcategory.objects.all()
    maincategory = Maincategory.objects.all()
    return render(Request,"checkout.html",{'data':buyer,'brand':brand,'subcategory':subcategory,'maincategory':maincategory})
...
def confirmationPage(Request):
    ...
    if(username):
        try:
            ...
            subcategory = Subcategory.objects.all()
            maincategory = Maincategory.objects.all()
            return render(Request,"confirmation.html",{'data':buyer,'brand':brand,'subcategory':subcategory,'maincategory':maincategory})
        except: 
...
def contactPage(Request):
    if(Request.method=="POST"):
        ...
        c.save()
        messages.success(Request,"Thanks to Share Your Query With Us. Our Team Wil Contact You Soon!!!")
    brand = Brand.objects.all()
    subcategory = Subcategory.objects.all()
    maincategory = Maincategory.objects.all()
    return render(Request,"contact.html",{'brand':brand,'subcategory':subcategory,'maincategory':maincategory})
